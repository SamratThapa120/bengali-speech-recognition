...
class Configs(Base):
    OUTPUTDIR="../workdir/wav2vec2_characterlevel_pretrained_indic_ctcloss_prepreocessor_augmented"
    ...
    def __init__(self,inference_files=None,inference_text=None,use_numpy=False):
        ...
        self.model = Wav2Vec2Base(len(self.VOCAB_NOSPECIAL)+1,
                                ...
                                pretrained="facebook/wav2vec2-large-960h-lv60-self"  if inference_files is None else None,
