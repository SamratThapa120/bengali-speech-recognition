...
class Configs(Base):
    OUTPUTDIR="../workdir/wav2vec2_characterlevel_pretrained_indicpre_ctcloss_prepreocessor_augmented_step_finetune"
    ...
    def __init__(self,inference_files=None,inference_text=None,use_numpy=False):
        ...
        self.model = Wav2Vec2Base(len(self.VOCAB_NOSPECIAL)+1,
                                ...
                                pretrained="ai4bharat/indicwav2vec_v1_bengali"  if inference_files is None else None,
