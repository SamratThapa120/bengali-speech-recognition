...
from bengali_asr.dataset.encoder_decoder_dataset import SpeechRecognitionCTCDataset
...
import os 
class Configs(Base):
    OUTPUTDIR="../workdir/whisperbase_characterlevel_finetuned_nolm_posembd_ctcloss_freezeenc"
