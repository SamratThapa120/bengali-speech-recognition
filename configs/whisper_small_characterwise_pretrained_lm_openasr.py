from bengali_asr.models import Whisper,ModelDimensions
...
class Configs(Base):
    ...
    VOCAB = all_combinations= ['ব', 'া', 'ং', 'ল', 'দ', 'ে', 'শ', ' ', 'য', '়', 'ি', 'ত', '্', 'ন', 'এ', 'ধ', 'র', 'ণ', 'ক', 'ড', 'হ', 'উ', 'প', 'জ', 'অ', 'থ', 'স', 'ষ', 'ই', 'আ', 'ছ', 'গ', 'ু', 'ো', 'ও', 'ভ', 'ী', 'ট', 'ূ', 'ম', 'ৈ', 'ৃ', 'ঙ', 'খ', 'ঃ', '১', '৯', '৬', '০', '২', 'চ', 'ঘ', 'ৎ', '৫', '৪', '-', '‘', '’', 'ফ', ',', 'ৌ', '৮', 'ঁ', 'য়', '৩', 'ঢ', 'ঠ', '৭', ':', '।', '.', 'ড়', 'ঝ', '/', 'ঞ', '"', "'", 'ঔ', 'ঈ', 'ঐ','!', 'ঋ', 'ঊ', '?', '–', ';', 'ঢ়', '—']
